    ...
    public function parse(string $raw, string $uri = ''): ContactData
    {
        ...
        try {
            ...
            return new ContactData(
                ...
                phoneticGivenName: $this->textProperty($vCard, 'X-PHONETIC-FIRST-NAME'),
                phoneticMiddleName: $this->textProperty($vCard, 'X-PHONETIC-MIDDLE-NAME'),
                phoneticFamilyName: $this->textProperty($vCard, 'X-PHONETIC-LAST-NAME'),
                phoneticOrganization: $this->textProperty($vCard, 'X-PHONETIC-ORG'),
                previousFamilyName: $this->textProperty($vCard, 'X-MAIDEN-NAME'),
